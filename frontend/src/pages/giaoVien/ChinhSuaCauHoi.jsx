...
const ChinhSuaCauHoi = () => {
  ...
  return (
    <div>
      ...
      <div style={{ background: 'var(--bg-surface)', padding: '2rem', borderRadius: '0.75rem', boxShadow: 'var(--shadow)' }}>
        <p style={{ color: 'var(--text-secondary)', marginBottom: '1rem' }}>Nhập câu hỏi theo định dạng văn bản thô:</p>
        <textarea
          rows={20}
          placeholder={'Câu 1: Nội dung câu hỏi\nA. Lựa chọn A\nB. Lựa chọn B\nC. Lựa chọn C\nD. Lựa chọn D\nĐáp án: A\n\nCâu 2: ...'}
          style={{ width: '100%', padding: '0.75rem', border: '1px solid var(--border-default)', borderRadius: '0.5rem', fontFamily: 'monospace', fontSize: '0.875rem', resize: 'vertical', boxSizing: 'border-box' }}
        />
        <div style={{ display: 'flex', gap: '0.75rem', marginTop: '1rem', justifyContent: 'flex-end' }}>
          <button onClick={() => navigate(-1)} style={{ padding: '0.5rem 1.25rem', border: '1px solid var(--border-default)', borderRadius: '0.5rem', background: 'var(--bg-surface)', cursor: 'pointer' }}>Hủy</button>
