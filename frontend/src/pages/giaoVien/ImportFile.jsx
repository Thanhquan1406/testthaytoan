    ...
    return (
        <div style={{ padding: '1.5rem', background: '#f8fafc', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ maxWidth: '840px', width: '100%', margin: '0 auto', textAlign: 'center' }}>
                ...
                <div 
                    style={{ background: '#fff', borderRadius: '0.5rem', padding: '3.5rem 2rem', boxShadow: '0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06)', border: '1px solid #e5e7eb', cursor: 'pointer' }}
                    onDrop={handleDrop}
